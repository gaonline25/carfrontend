...
import Link from "next/link";
import { fetchAllServices, getImageUrl } from "@/lib/fetchAllServices";
import WhatWeOfferBanner from "@/components/WhatWeOfferBanner";
              ...
              <div role="list" className="carsy-services-grid w-dyn-items">
                {services.map((service) => {
                  const backgroundImageUrl = getImageUrl(
                    service.bannerSection?.backgroundImage?.desktop
                  );

                  // Skip rendering if no background image from Payload
