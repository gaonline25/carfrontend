...
// //   const { gradientWrapper = {}, heroBanner = {}, contentSection = {} } = data;
...
// //           {gradientWrapper.printImage?.show && (
// //             <div className="print-wrapper-1">
// //               {/* <img src={getImageUrl(gradientWrapper.printImage.url)} loading="lazy" alt={gradientWrapper.printImage.alt} className={gradientWrapper.printImage.className} /> */}
// //             </div>
// //           )}
// //         </div>
// //       )}
...
// //       {/* Content Section */}
// //       {contentSection.show && (
// //         <div className={contentSection.className}>
// //           <div className="soft-black-bg">
// //             <div className="base-container">
// //               <div id="Service-details" className="services-template-wrap">
// //                 <div className="subtitle-wrap">
// //                   <h6 className={contentSection.subtitleClass}>
...
// //                     __html: renderRichText(contentSection.richText),
// //                   }}
// //                 />
// //               </div>
// //             </div>
...
//     fetchAboutHeroComponentData().then((fetchedData) => {
//       setData(fetchedData);
//       // Log the full fetched data for debugging
...
//   // Log contentSection for debugging
//   console.log("Content Section data:", contentSection);
//   console.log("Content Section show:", contentSection.show);
//   console.log("Content Section subtitle:", contentSection.subtitle);
//   const renderedHtml = renderRichText(contentSection.richText);
//   console.log("Rendered rich text HTML:", renderedHtml);
...
export default function AboutHero() {
  ...
  console.log("Content Section show:", contentSection.show);
  console.log("Content Section subtitle:", contentSection.subtitle);
  const renderedHtml = renderRichText(contentSection.richTextContent); // Fixed: use richTextContent
  console.log("Rendered rich text HTML:", renderedHtml);

  const bottomGradient = contentSection.bottomGradient;
  ...
  return (
    <div className="relative-page-wrapper">
      ...
      {contentSection.show && (
        <div
          className={contentSection.className || "section-gray padding-bottom"}
        >
          <div className={contentSection.innerWrapperClass || "soft-black-bg"}>
            <div className={contentSection.containerClass || "base-container"}>
              <div
                id={contentSection.contentWrapperId || "Service-details"}
                className={
                  contentSection.contentWrapperClass || "services-template-wrap"
                }
              >
                <div className="subtitle-wrap">
                  <h6
                    className={contentSection.subtitleClass || "black-subtitle"}
                  >
                    {contentSection.subtitle}
                  </h6>
                </div>
          ...
          {/* Bottom Gradient - Dynamic */}
          {bottomGradient?.show && (
            <div
              className={
                bottomGradient.wrapperClass || "gradient-wrapper grad-wrapper-3"
              }
            >
              {bottomGradient.gradients?.map((grad: any, i: number) => (
                <div
                  key={i}
                  data-w-id={grad.dataWId}
