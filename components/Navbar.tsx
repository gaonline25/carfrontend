function Navigation() {
  return (
    <div
      ...
      className="navigation-fixed-menu w-nav"
      data-easing2="ease"
      data-easing="ease"
      ...
      data-doc-height="1"
    >
      <div className="nav-bg-cover"></div>
          ...
          <nav role="navigation" className="nav-menu-wrap w-nav-menu">
            <div className="nav-menu-shadow-overlay-5">
              <div className="tablet-menu-5">
                ...
                <div className="close-menu-button-4 w-nav-button">
                  <img
                    width="40"
                    height="40"
                    alt="Icon"
                    src="https://cdn.prod.website-files.com/669e1212d181ce4bfbbea175/669fa8233d63db8a5c68c0d1_Icon%203.svg"
                    className="nav-close-icon-5"
                  />
                </div>
              </div>
              <div className="dropdown-menu-4">
                <div className="top-tablet-menu-3">
                  <div className="border-wrap-4">
                    <div
                      data-delay="0"
                      data-hover="true"
                      data-w-id="a86f8d6c-670c-9667-9108-23bcd86f3927"
                    ...
                    <div
                      data-delay="0"
                      data-hover="true"
                      data-w-id="a86f8d6c-670c-9667-9108-23bcd86f3945"
                      className="hero-nav-dropdown w-dropdown"
                    >
                      <div className="dropdown-header-item-2 w-dropdown-toggle">
                        <div className="nav-text-wrap">
    ...
    site {
      commerce {
        ...
        quickCheckoutEnabled
                ...
                className="w-commerce-commercecartwrapper shop-cart"
              >
                <a
                  href="#"
                  ...
                  role="button"
                  className="w-commerce-commercecartopenlink cart-button-item w-inline-block"
                >
                  <div className="hover-nav-cover tablet-hide"></div>
                  <p className="shop-icon"></p>
                  <svg
                    className="w-commerce-commercecartopenlinkicon old-icon-shop"
                    width="17px"
                    height="17px"
                    viewBox="0 0 17 17"
                  >
                  ...
                  <div className="hero-nav-con">
                    <div className="nav-clip">
                      <p className="nav-intro-item-white nav-cart">cart</p>
                    </div>
                    <div className="nav-clip bottom">
                      <p className="nav-intro-item-white nav-cart-hover">
                        cart
                      </p>
                    </div>
                  </div>
                  <div className="display-hide w-inline-block">Cart</div>
                  <div className="quantity-wrapper">
                    <p className="nav-intro-item-white nav-cart">(</p>
                    <div
                ...
                <div
                  ...
                  style={{ display: "none" }}
                  className="w-commerce-commercecartcontainerwrapper w-commerce-commercecartcontainerwrapper--cartType-rightSidebar shop-cart-wrapper"
                >
                  <div
                    role="dialog"
                  ...
                  >
                    <div className="w-commerce-commercecartheader cart-header-2">
                      <h5 className="w-commerce-commercecartheading your-cart-2">
                        Your Cart
                      </h5>
                      <a
                        href="#"
                        ...
                        data-w-id="a86f8d6c-670c-9667-9108-23bcd86f3a3a"
                        className="w-commerce-commercecartcloselink close-button w-inline-block"
                      >
                        <svg
                          className="your-cart-icon"
                          width="16px"
                          height="16px"
                          viewBox="0 0 16 16"
                        >
                    ...
                    <div className="w-commerce-commercecartformwrapper">
                      ...
                      >
                          ...
                          <div className="w-commerce-commercecartitem cart-hero-item">
                            <div className="cart-flex-item">
                              <img
                                ...
                                alt=""
                                className="w-commerce-commercecartitemimage image-order w-dyn-bind-empty"
                              />
                              <div
                                id="w-node-a86f8d6c-670c-9667-9108-23bcd86f3a43-d86f3916"
                                className="w-commerce-commercecartiteminfo product-content"
                              >
                                <div
                                  ...
                                  className="w-commerce-commercecartproductname cart-product-name w-dyn-bind-empty"
                                ></div>
                                <div
                                ...
                                <script
                                  type="text/x-wf-template"
                                  id="wf-template-a86f8d6c-670c-9667-9108-23bcd86f3a46"
                                  dangerouslySetInnerHTML={{
                                    __html:
                                ...
                                <ul
                                  ...
                                  data-wf-template-id="wf-template-a86f8d6c-670c-9667-9108-23bcd86f3a46"
                                >
                                  <li className="option">
                              ...
                              <input
                                ...
                                id="w-node-a86f8d6c-670c-9667-9108-23bcd86f3a51-d86f3916"
                                ...
                                className="w-commerce-commercecartquantity quantity-cart"
                                required
                                pattern="^[0-9]+$"
                                inputMode="numeric"
                                type="number"
                        ...
                        <div className="w-commerce-commercecartfooter cart-footer-2">
                          <div
                            aria-live="polite"
                            aria-atomic="true"
                          ...
                          >
                            ...
                            <div
                              ...
                              className="w-commerce-commercecartordervalue subtotal-text bold"
                            ></div>
                          </div>
                          <div className="checkout-actions">
                            ...
                            >
                              <a
                                ...
                                className="w-commerce-commercecartapplepaybutton apple-play"
                              >
                                <div></div>
                              </a>
                              <a
                            ...
                            <a
                              ...
                              className="w-commerce-commercecartcheckoutbutton primary-button-form"
                      ...
                      <div className="w-commerce-commercecartemptystate empty-cart-state">
                        <div
                          aria-live="polite"
                        ...
                        <div className="gradient-wrapper">
                          <div className="print-wrapper-1 print-cart--2">
                            <img
                          ...
                          <div
                            data-w-id="a86f8d6c-670c-9667-9108-23bcd86f3a67"
                            className="red-grad-15"
                          ></div>
                          <div
                            data-w-id="a86f8d6c-670c-9667-9108-23bcd86f3a68"
                            className="red-grad-16"
                          ></div>
                        </div>
                      </div>
                      <div
                        ...
                        className="w-commerce-commercecarterrorstate main-error-message"
                      >
                        <div
